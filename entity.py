"""Base entity for Extended OpenAI Conversation integration."""
...
class OpenAIBaseLLMEntity(Entity):
    ...
    async def _async_handle_chat_log(self, chat_log: list[dict], task_name: str, structure: dict | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            if structure:
                ...
                try:
                    ...
                    return {"error": f"Failed to parse JSON: {str(e)}", "raw_response": content}
            else:
